"""
train and eval ResNet on PlantsDisease Dataset
Author: XuLu
"""
import os
import sys
...
sys.path.append('../')
from pdr import data_loader
from pdr.utils import mkdirs_if_not_exist
...
def run_license_type_rec(model, epoch):
    ...
    trainloader, valloader = data_loader.load_plants_disease_dataset()
