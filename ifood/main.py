...
sys.path.append('../')
from ifood import data_loader
from ifood.utils import mkdirs_if_not_exist
from ifood.cfg import cfg


def train_model(model, dataloaders, criterion, optimizer, scheduler, inference=False):
    """
...
if __name__ == '__main__':
    ...
    # batch_inference(resnet, data_loader.load_ifood_inference())
